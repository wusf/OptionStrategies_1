...
plt.title('CoveredCall|IV='+repr(IV)+'|LeverageRatio='+repr(int(leverage)), color = 'black',fontweight="bold")
date = out[0]
#plt.show()
plt.savefig('Covered_Call_Strategy.jpeg', dpi=100, format="jpeg")
plt.close(fig) 
